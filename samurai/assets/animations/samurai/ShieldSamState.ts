...
@ccclass("ShieldSamState")
export class ShieldSamState extends animation.StateMachineComponent {
  /**
  ...
  public onMotionStateEnter(
    ...
    // Can be overrode
    console.log("shield enter:", controller.getValue("isShieldBroken"))
  }
  ...
  public onMotionStateExit(
    ...
    // Can be overrode
    console.log("shield exit:", controller.getValue("isShieldBroken"))
  }
  ...
  public onMotionStateUpdate(
    ...
    // Can be overrode
    console.log("shield update:", controller.getValue("isShieldBroken"))
  }
